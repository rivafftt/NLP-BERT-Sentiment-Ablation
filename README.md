...
本项目聚焦于中文文本情感二分类任务，基于公开的[ **ChnSentiCorp** 数据集](https://www.kaggle.com/datasets/kaggleyxz/chnsenticorp)展开全流程的系统化建模与深层对比。通过结合传统特征工程基线与深度学习端到端微调方案，探索预训练权重与微调策略对大语言模型泛化性能的深层贡献。
